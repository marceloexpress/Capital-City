const Targeting = Vue.createApp({
    data() {
        return {
            ...
            SuccessColor: "rgb(3, 187, 232)", // This is the color when the target has found the option
            ...
            for (let [index, itemData] of Object.entries(item.data)) {
                if (itemData !== null) {
                    ...
                    if (this.ChangeTextIconColor) {
                        this.targetLabel.innerHTML +=
                            `<div class="option" id="target-option-${index}" style="margin-bottom: 1vh; color: ${this.StandardColor}">
