...
RegisterNetEvent('CarryPeople:syncTarget55')
AddEventHandler('CarryPeople:syncTarget55', function(target, animationLib, animation2, distans, distans2, height, length,spin,controlFlag)
...
RegisterNetEvent('CarryPeople:syncM55')
AddEventHandler('CarryPeople:syncMe55', function(animationLib, animation,length,controlFlag,animFlag)
	local playerPed = PlayerPedId()
	RequestAnimDict(animationLib)
...
RegisterNetEvent('CarryPeople:cl_stop55')
AddEventHandler('CarryPeople:cl_stop55', function()
