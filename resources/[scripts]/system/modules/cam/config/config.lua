Cam = {
    ...
    strings = {
        ...
        hideMenuCam     = 'Ocultar menu',
        hideMenuCamDesc = 'Oculte o menu para gravações, etc.',

        precision       = 'Precisão da Câmera',
        precisionDesc   = 'Alterar movimento de precisão da câmera',
        ...
        delFilterDesc   = 'Remover o filtro e redefinir os valores',

        freeFly         = 'Alternar Modo Free Fly',
        freeFlyDesc     = 'Alternar entre Modo Free Fly ou Modo Drone',

        charControl     = 'Alternar Controle de Personagem',
        charControlDesc = 'Alternar entre Controle de Personagem ou Controle de Câmera',
        ...
        pointEntityDesc = 'Ativar/desativar apontar para a entidade selecionada',

        ctrlHelpRoll    = 'Inclinar Esquerda/Direita',
