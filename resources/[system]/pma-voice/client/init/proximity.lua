...
CreateThread(function()
    ...
    while true do
        ...
        TriggerEvent("hud:playerTalking",NetworkIsPlayerTalking(PlayerId()) == 1)
...
-- 	local hospital = GetInteriorAtCoords(-2079.574, -460.4308, 12.17725)
--     while true do
-- 		local idle = 1000
-- 		if (hospital == GetInteriorFromEntity(PlayerPedId())) then
-- 			idle = 100
-- 			if (mode ~= 1) then
-- 				mode = 1
-- 				setProximityState(Cfg.voiceModes[mode][1], false)
-- 				TriggerEvent('hud:setTalkingMode', Cfg.voiceModes[mode][2])
-- 			end
-- 		end
-- 		Citizen.Wait(idle)
-- 	end
