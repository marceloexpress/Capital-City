LocalPlayer.state:set('disableTarget', false, true)
...
local function EnableTarget()
	if LocalPlayer.state.Handcuff or LocalPlayer.state.StraightJacket then return end
	...
	if LocalPlayer.state.disableTarget or targetActive or not CheckOptions then return end
